#include <iostream>
 ...
 void findLargestElements(const vector<int>& arr, int& secondLargest, int& thirdLargest) {
     // Initialize largest, secondLargest, and thirdLargest to the minimum possible integer value
     int largest = INT_MIN;
     ...
     // In case no valid second or third largest element is found
